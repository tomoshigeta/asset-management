...
(function () {
  ...
  const PIE_ASSET = ["#2474cf", "#9752b4", "#17a478"];  /* 藍 不動産 / 菫 有価証券 / 翡翠 預貯金 */
  const PIE_DEBT  = ["#2474cf", "#00a58f", "#b2468a"];  /* 藍 不動産 / 青緑 多目的 / 薔薇 自動車 */
  /* 不動産と不動産ローンが同じ藍なのは、貸借の両側にある同じ対象だから。
     暖色（琥珀）を初版で使ったが、明度帯の制約で彩度が落ちて濁るため寒色系に替えた。 */
